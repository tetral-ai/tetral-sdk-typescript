...
// ToolRunner helper. Tetral defers generated beta Messages APIs and hosted
// ToolRunner flows in this stage; use Sessions Events `user.message` for
// supported Tetral session input.
